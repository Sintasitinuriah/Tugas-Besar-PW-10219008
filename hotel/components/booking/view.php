	...
	<div class="container-fluid my-4">
		...
		?>
			<tr> 
				...
				<td>
					<a href="update.php?id=<?php echo $r["id"]; ?>"><button type="button" class="btn btn-outline-info">Edit</button></a>

					<button type="button" class="btn btn-outline-danger btn-xs" data-toggle="modal" data-target="#myModal">Delete</button>
